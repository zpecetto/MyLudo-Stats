...
[Jeux de société.json](Workflow/Jeux%20de%20soci%C3%A9t%C3%A9.json) contient 23 nœuds.

Extraction à partir de **Paramètres MyLudo** : contrôle d’accès, parcours de la ludothèque et des fiches par lots, validation des données, table de jeux, statistiques de collection et de souhaits, puis Google Sheets. La boucle **Boucle des fiches** est conservée.

## Configuration du service

Dans **Paramètres MyLudo**, remplacer `YOUR_MYLUDO_PROFILE_ID`, adapter Browserless, les cookies si nécessaires et la taille des lots. Configurer Discord. La table n’est vidée qu’après validation de l’ensemble extrait par les nœuds de contrôle.
